...
-- Raise maintenance_work_mem just for this build (the ivfflat index needs more than
-- the Supabase free-tier default of 32MB, else it fails with SQLSTATE 54000).
